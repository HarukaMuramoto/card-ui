...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = (function (_super) {
	    ...
	    Card.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement("div", {className: "front-img " + this.props.class}, React.createElement("img", {src: this.props.frontimg}), React.createElement("article", {className: "card-contents"}, React.createElement("div", {className: "upper-txt"}, React.createElement("p", {className: "main-detail"}, this.props.cardname, ":", this.props.cardage, ":", this.props.cardpref), React.createElement("p", {className: "massage"}, this.props.cardmsg)), React.createElement("p", {className: "more-detail"}, this.props.cardjob, "  |  ", this.props.cardheight)))));
	    };
	    return Card;
	}(React.Component));
	exports.Card = Card;
